            ...
            <div class="col-lg-6 col-5 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><?php echo anchor('gudang/users', 'User'); ?></li>
...
<script>
    ...
    $('#deleteUser').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('gudang/users/api/delete'); ?>',
        data: {
            id: id
        },
        success: function (res) {
          if (res.code == 204) {
            ...
            setTimeout(() => {
                window.location = '<?php echo site_url('gudang/users'); ?>';
            }, 4000);
          }
        }
      })
