            ...
            <div class="col-lg-6 col-5 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo site_url('gudang/orders'); ?>">Order</a></li>
          ...
          <div class="card-wrapper">
            <div class="card">
              ...
              <div class="card-footer">
                <form action="<?php echo site_url('gudang/orders/status'); ?>" method="POST">
        ...
        <div class="col-md-4">
            <div class="card card-primary">
                ...
                <div class="card card-primary" id="#payments">
                    ...
                    <?php if ($data->payment_price != NULL) : ?>
                    <div class="card-footer">
                        <form action="<?php echo site_url('gudang/payments/verify'); ?>" method="POST">
                        <div class="row">
