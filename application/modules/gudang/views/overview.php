...
<!-- Header -->
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        ...
        <?php
 foreach ($order_overviews as $order) :
  echo $order->sale; 
  if($order>=50){
  $orderproducts="Pemberitahuan: Penjualan di Bulan ini Relatif Aman";
  }else if ($order>=40){
  $orderproducts="Pemberitahuan: Penjualan di Bulan ini Baik";
  }else if ($order>=30){
  $orderproducts="Pemberitahuan: Penjualan di Bulan ini Cukup";
  }else if ($order>=20){
  $orderproducts="Perhatian: Sistem Penjualan Belum Mencapai Target!";
  }else if ($order>=1){
  $orderproducts="Bahaya: Penjualan di Bulan ini Mengalami Penurunan!";
  }else{
  $orderproducts="Bahaya: Produk belum terjual satupun di bulan ini";
  }

  echo "Pesan ".$orderproducts."<br>";
              ...
              <?php foreach ($customers as $customer) : ?>
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                      <a href="<?php echo site_url('gudang/customers/view/'. $customer->id); ?>" class="btn btn-sm btn-primary">Profil</a>
                    </div>
                  </div>
                </li>
                <?php endforeach; ?>
                ...
                <li class="checklist-entry list-group-item flex-column align-items-start py-4 px-4">
                  <div class="checklist-item checklist-item-info">
                    <div class="checklist-info">
                      <h5 class="checklist-title mb-0"><?php echo anchor('gudang/orders/view/'. $order->id, 'Order #'. $order->order_number); ?></h5>
              ...
              <?php foreach ($payments as $payment) : ?>
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="<?php echo site_url('gudang/payments/users/'. $payment->user_id); ?>" class="avatar rounded-circle">
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('gudang/products'); ?>" class="btn btn-sm btn-primary">Lihat semua</a>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('gudang/products/category'); ?>" class="btn btn-sm btn-primary">Lihat semua</a>
                </div>
              </div>
            </div>
            <div class="table-responsive">
