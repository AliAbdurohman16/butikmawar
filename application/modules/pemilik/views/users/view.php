        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">User #<?php echo $user->id; ?></h6>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="#"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><?php echo anchor('pemilik/users', 'User'); ?></li>
                  <li class="breadcrumb-item active" aria-current="page">#<?php echo $user->id; ?> <?php echo $user->name; ?></li>
                </ol>
              </nav>
            </div>
          </div>
              ...
              <div class="card-body p-0">
                <table class="table align-items-center table-flush table-hover">
                    ...
                    <tr>
                        ...
                        <td><b><?php echo $user->register_date; ?></b></td>
                    </tr>
                    <tr>
                        <td>Role</td>
                        <td><b><?php echo $user->role_id; ?></b></td>
                    </tr>
                    <tr>
                </table>
              </div>
              <div class="card-footer">
                <a href="#" data-id="<?php echo $user->id; ?>" class="btn btn-danger btn-sm btnDelete"><i class="fa fa-trash"></i></a>
              </div>
...
<script>
    ...
    $('#deleteUser').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('pemilik/users/api/delete'); ?>',
        data: {
            id: id
        },
        success: function (res) {
          if (res.code == 204) {
            ...
            setTimeout(() => {
                window.location = '<?php echo site_url('pemilik/users'); ?>';
            }, 4000);
          }
        }
      })
