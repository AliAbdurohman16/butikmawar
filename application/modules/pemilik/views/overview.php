          ...
          <div class="card bg-default">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-light text-uppercase ls-1 mb-1">Ringkasan</h6>
                  <h5 class="h3 text-white mb-0">Konsumen</h5>
                </div>
              </div>
            </div>
            <div class="card-body">
              ...
              <?php foreach ($customers as $customer) : ?>
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                      <a href="<?php echo site_url('pemilik/customers/view/'. $customer->id); ?>" class="btn btn-sm btn-primary">Profil</a>
                    </div>
                  </div>
                </li>
                <?php endforeach; ?>
                ...
                <li class="checklist-entry list-group-item flex-column align-items-start py-4 px-4">
                  <div class="checklist-item checklist-item-info">
                    <div class="checklist-info">
                      <h5 class="checklist-title mb-0"><?php echo anchor('pemilik/orders/view/'. $order->id, 'Order #'. $order->order_number); ?></h5>
              ...
              <?php foreach ($payments as $payment) : ?>
                <li class="list-group-item px-0">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <a href="<?php echo site_url('pemilik/payments/users/'. $payment->user_id); ?>" class="avatar rounded-circle">
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('pemilik/products'); ?>" class="btn btn-sm btn-primary">Lihat semua</a>
                </div>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('pemilik/products/category'); ?>" class="btn btn-sm btn-primary">Lihat semua</a>
                </div>
              </div>
            </div>
            <div class="table-responsive">
...
function initChart($chart) {
  ...
  var ordersChart = new Chart($chart, {
    ...
    data: {
      labels: [
        <?php foreach ($best_customer as $customer) : ?>
            '<?php echo get_month($customer->month); ?>',
        <?php endforeach; ?>
      ],
      datasets: [{
        label: 'Konsumen',
