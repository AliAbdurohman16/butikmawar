            ...
            <div class="col-lg-6 col-5 text-right">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><?php echo anchor('pemilik/contacts', 'Kontak'); ?></li>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
            <div class="card card-primary">
                ...
                <form action="<?php echo site_url('pemilik/contacts/reply'); ?>" method="POST">
...
<script>
    ...
    $('#deleteContact').submit(function(e) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo site_url('pemilik/contacts/api/delete'); ?>',
        data: {
            id: id
        },
        success: function (res) {
          if (res.code == 204) {
            ...
            setTimeout(() => {
                window.location = '<?php echo site_url('pemilik/contacts'); ?>';
            }, 4000);
          }
        }
      })
