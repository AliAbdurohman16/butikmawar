...
class Products extends CI_Controller {
    ...
    public function index()
    {
        ...
        $config['base_url'] = site_url('pemilik/products/index');
    ...
    public function search()
    {
        ...
        $config['base_url'] = site_url('pemilik/products/search');
        $config['total_rows'] = $this->product->count_all_products();
        $config['per_page'] = 16;
        $config['uri_segment'] = 4;
        $choice = $config['total_rows'] / $config['per_page'];
    ...
    public function add_product()
    {
        ...
        else
        {
            ...
            redirect('pemilik/products/add_new_product');
        }
    }
    ...
    public function edit_product()
    {
        ...
        else
        {
            ...
            redirect('pemilik/products/view/'. $id);
        }
    }
