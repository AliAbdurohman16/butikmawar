...
class Admin extends CI_Controller {
    ...
    public function index()
    {
        ...
        $overview['customer_potentials'] = $this->customer->customer_potential();
        $overview['product_potentials'] = $this->product->product_potential();
        $overview['get_coupons'] = $this->product->get_coupon();
