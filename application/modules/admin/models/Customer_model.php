...
class Customer_model extends CI_Model {
    ...
    public function customer_potential()
    {
        return $this->db->select('SUM(orders.total_items) as total, users.name as name')
                        ->from('orders')->join('users', 'users.id = orders.user_id')
