...
<div class="container-fluid mt--6">
      ...
      <div class="card">
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              <h6 class="text-uppercase text-muted ls-1 mb-1">Ringkasan</h6>
              <h5 class="h3 mb-0">Customer Potensial</h5>
            </div>
          </div>
        </div>
        <div class="card-body">
          <canvas id="chart-customer" class="chart-canvas"></canvas>
        </div>
      </div>
    </div>
    <div class="col-xl-6">
      <div class="card">
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              <h6 class="text-uppercase text-muted ls-1 mb-1">Ringkasan</h6>
              <h5 class="h3 mb-0">Produk Terlaris</h5>
            </div>
          </div>
        </div>
        <div class="card-body">
          <canvas id="chart-product" class="chart-canvas"></canvas>
        </div>
      </div>
    </div>
    <div class="col-xl-6">
      <div class="card">
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              <h6 class="text-uppercase text-muted ls-1 mb-1">Ringkasan</h6>
              <h5 class="h3 mb-0">Kupon Digunakan</h5>
            </div>
          </div>
        </div>
        <div class="card-body">
          <canvas id="chart-coupon" class="chart-canvas"></canvas>
        </div>
      </div>
    </div>
  ...
  <script src="<?php echo base_url('assets/vendor/charts/charts.min.js'); ?>"></script>
  <script type="text/javascript">
    ...
    var ctx = document.getElementById('chart-customer').getContext('2d');
    var myChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: [
          <?php foreach ($customer_potentials as $potential) : ?> '<?php echo $potential->name; ?>',
          <?php endforeach; ?>
        ],
        datasets: [{
          label: 'Income Pendapatan',
          ...
          borderColor: '#14147a',
          data: [
            <?php foreach ($customer_potentials as $potential) : ?> '<?php echo $potential->total; ?>',
            <?php endforeach; ?>
          ]
        }]
      },
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        labels: [
          <?php foreach ($product_potentials as $product) : ?> '<?php echo $product->name; ?>',
          <?php endforeach; ?>
        ],
        datasets: [{
          ...
          borderColor: '#14147a',
          data: [
            <?php foreach ($product_potentials as $product) : ?> '<?php echo $product->total; ?>',
            <?php endforeach; ?>
          ]
        }]
      },
    ...
    var ctx = document.getElementById('chart-coupon').getContext('2d');
    var myChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: [
          <?php foreach ($get_coupons as $coupon) : ?> '<?php echo $coupon->name; ?>',
          <?php endforeach; ?>
        ],
        datasets: [{
          ...
          borderColor: '#14147a',
          data: [
            <?php foreach ($get_coupons as $coupon) : ?> '<?php echo $coupon->total; ?>',
            <?php endforeach; ?>
          ]
        }]
      },
