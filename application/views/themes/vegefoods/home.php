      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Salah Satu Butik Yang Menjamin Kualitas Bahan dan Jahitan Pada Busana</h1>
            <h2 class="subheading mb-4">Menyediakan Berbagai Busana Muslim dan Muslimah Yang Berkualitas</h2>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">100% Dengan Kain Yang Berkualitas</h1>
            <h2 class="subheading mb-4">Busana Muslim dan Muslimah Yang Kekinian</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg_3.jpg'); ?>);">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Hanya Menjual Busana Dengan Kualitas Terbaik</h1>
            <h2 class="subheading mb-4">Busana Muslim dan Muslimah Yang Kekinian</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
    ...
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          <h3 class="heading">Jahitan Terbaik</h3>
          <span>Di Jahit Dengan Rapih</span>
        </div>
      </div>    
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
      <div class="media block-6 services mb-md-0 mb-4">
        ...
        <div class="media-body">
          ...
          <span>Kualitas dari Kain Terbaik</span>
        </div>
      </div>      
    </div>
    <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
  ...
  <div class="container">
    ...
    <div class="col-md-8 heading-section ftco-animate deal-of-the-day ftco-animate">
        <span class="subheading">Busana dengan Harga Terbaik</span>
