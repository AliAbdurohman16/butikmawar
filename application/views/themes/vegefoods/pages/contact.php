...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg_2.jpg'); ?>');">
  ...
  <section class="ftco-section contact-section bg-light">
    <div class="container">
        ...
        <div class="col-md-3 d-flex">
            <div class="info bg-white p-4">
              <p><span>Website</span> www.butikmawarkng.com</p>
            </div>
        </div>
      </div>
      <div class="row block-9">
        ...
        <div class="col-md-6 d-flex">
            <div style="width: 100%">
                <iframe src="https://www.google.com/maps/embed?pb=!3m2!1sen!2sid!4v1663515335367!5m2!1sen!2sid!6m8!1m7!1sT-3Vyj0-1GqxmmpZTveTmg!2m2!1d-6.976117474514754!2d108.4769994683194!3f308.00638973834685!4f-6.405304521161568!5f0.7820865974627469" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">find my coordinates</a>
                </iframe>
            </div>
        </div>
      </div>
